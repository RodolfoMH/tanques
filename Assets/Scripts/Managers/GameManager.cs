...
public class GameManager : MonoBehaviour
{
    ...
    [HideInInspector] public int m_player1Score = 0; 
    [HideInInspector] public int m_player2Score = 0; 
    ...
    private IEnumerator RoundEnding()
    {
        ...
        if (m_RoundWinner != null)
        {
            ...
            if(m_RoundWinner.m_PlayerNumber==1){m_player1Score++;}else{m_player2Score++;}
        }
    ...
    private string EndMessage()
    {
        ...
        if (m_GameWinner != null)
        {
            ...
            {
                message+="VICTORIAS "+m_player1Score+" / "+(m_player2Score+m_player1Score);
            }else
            {
                message+="VICTORIAS "+m_player2Score+" / "+(m_player2Score+m_player1Score);
            }
        }
